...
def send_public_purchase_announcement(order, transaction):
    ...
    try:
        ...
        announcement = (
            f"🌟 <b>NEW PREMIUM SUBSCRIPTION!</b> 🌟\n\n"
            f"✨ User {masked_username} has purchased:\n"
            f"💎 <b>{order.plan_name}</b>\n"
            f"💰 Price: <b>${formatted_amount}</b>\n\n"
            f"⚡️ Get access to Telegram premium features:\n"
            f"✓ Increased limits\n"
            f"✓ Exclusive stickers and reactions\n"
            f"✓ Enhanced media uploads\n"
            f"✓ Premium featuresначок\n"
